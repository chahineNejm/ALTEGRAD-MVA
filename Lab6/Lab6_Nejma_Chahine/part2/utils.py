...
def load_cora():
    idx_features_labels = np.genfromtxt(r"C:\Users\ADMIN\Desktop\ALTEGRAD\ALTEGRAD-MVA\Lab6\data\cora.content", dtype=np.dtype(str))
    ...
    edges_unordered = np.genfromtxt(r"C:\Users\ADMIN\Desktop\ALTEGRAD\ALTEGRAD-MVA\Lab6\data\cora.cites", dtype=np.int32)
